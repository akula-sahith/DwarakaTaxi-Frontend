    ...
    <div className="bg-gray-50 py-12 px-4 font-['Bricolage_Grotesque','ui-sans-serif']">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image Placeholder */}
          <div className="bg-gray-300 rounded-3xl h-80 lg:h-96"></div>
          ...
          <div className="space-y-4 text-gray-800 leading-relaxed">
            ...
            <p className="text-base lg:text-lg">
              Travel made simple, safe, and affordable – that's our promise at Dwaraka Taxi. We're your trusted travel companion across Tamil Nadu, Kerala, Karnataka, Andhra Pradesh, Telangana, and Puducherry. From one-way rides to round trips, our experienced drivers and comfortable vehicles make every journey smooth and stress-free.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="bg-white rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Round-the-Clock Availability</h3>
            ...
            <div className="bg-white rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Verified and Professional Drivers</h3>
                  <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">Instant Booking via Web</h3>
                  <p className="text-sm text-gray-600">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-2">One-Way, Round Trips, and Airport Transfers</h3>
                  <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-black rounded-xl flex items-center justify-center flex-shrink-0">
                  <IndianRupee className="text-yellow-400" size={28} />
                </div>
                <div>
                  <h3 className="font-semibold text-lg mb-2">Transparent and Competitive Pricing</h3>
                  <p className="text-sm text-gray-600">
